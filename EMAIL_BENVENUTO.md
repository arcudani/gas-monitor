...
- Il paragrafo "profilo amministratore" si usa SOLO per ruolo `admin`;
  per i `cliente` si usa la variante indicata sotto.
...
- **Prezzo MGP-GAS** con i trend di breve, medio e lungo periodo;
- **Segnale di fixing**: un livello a gradini che indica quando si sta aprendo
  una finestra favorevole per fissare il prezzo, con l'azione suggerita.

Ci sono anche lo storico dal 2020, il dettaglio di ogni variabile, l'export
PDF/Excel e gli **alert email personali**: dalla sezione *Alert* puoi inserire
...
> [SOLO ruolo admin — aggiungere alla riga sopra:]
> Il tuo profilo è amministratore: oltre alla consultazione vedi anche la
> pagina *Admin* con i parametri del segnale e lo stato dei dati.

**Per orientarti**: nel portale trovi la sezione **📖 Guida**, che spiega come
leggere la dashboard, cosa significano i livelli del segnale, come impostare
gli alert e quali sono fonti e limiti dello strumento. Ti consiglio di partire
da lì.
